...
(function() { 
    ...
    async function testDesktopAddEventButton() { 
        ...
        if (!isMobile) { 
            ...
            if (quickAddBtn) { 
                ...
                warn('Quick Add button exists', 'Button with aria-label="Quick add event" not found - CHECK if this is intentional for read-only/view-only modes'); 
            } 
        } else { 
    ...
    // ============================================================ 
        ...
        async function runAllTests() {
            console.clear();
            console.log('%c🧪 PASTECAL SELF-TEST SUITE', 'font-size: 20px; font-weight: bold; color: #4CAF50');        console.log('%cRunning comprehensive UI and functionality tests...', 'color: #666'); 
